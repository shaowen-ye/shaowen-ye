...
- [Zhao_CalBMI](https://github.com/shaowen-ye/Zhao_CalBMI)
  Python 数据分析项目，名称指向 BMI 计算相关工作流。

- [MESI](https://github.com/shaowen-ye/MESI)
  Mass Effect Susceptibility Index，用于在元群落研究中计算物种对 mass effect 的易感性指数。

- [Cal_trait_gated_connectivity](https://github.com/shaowen-ye/Cal_trait_gated_connectivity)
  Python 分析项目，面向 trait-gated connectivity 相关计算。
...
- [MyCodex](https://github.com/shaowen-ye/MyCodex)
  Codex 相关个人配置或工作流整理仓库。
...
- 对没有完整 README 或描述的旧仓库，这里采用保守摘要；更详细的说明以后可以逐步补到各仓库自己的 README 中。
